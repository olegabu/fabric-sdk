...
public class ConsoleLinesToChaincodeParserTest {
    ...
    public void testCommittedOutputParsing() {
        Chaincode chaincode = Chaincode.fromCommittedLine("Name: dns, Version: 1.1, Sequence: 2, Endorsement Plugin: escc, Validation Plugin: vscc");
        assertThat(chaincode).isEqualTo(new Chaincode("dns", "1.1", 2));
    }
}
